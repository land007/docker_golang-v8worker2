...
CMD cd $GOPATH/src/github.com/ry/v8worker2 \
    && go test

#docker pull land007/golang-v8worker2 ; 
#docker stop golang-v8worker2 ; docker rm golang-v8worker2 ; docker run -it --privileged --name golang-v8worker2 land007/golang-v8worker2:latest
